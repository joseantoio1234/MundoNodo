...
<head>
    ...
    <style>
        ...
        .detail-container { max-width: 900px; margin: 0 auto; background: white; padding: 30px; border-radius: 12px; box-shadow: 0 4px 15px rgba(0,0,0,0.1); }
        .detail-title { color: #2c3e50; border-bottom: 3px solid #e67e22; padding-bottom: 10px; margin-bottom: 30px; display: flex; align-items: center; justify-content: space-between; }
        
        .product-img { width: 50px; height: 50px; object-fit: cover; border-radius: 5px; border: 1px solid #ddd; }
        .table-details { width: 100%; border-collapse: collapse; }
        .table-details th { background-color: #2c3e50; color: white; padding: 15px; text-align: left; }
        .table-details td { padding: 15px; border-bottom: 1px solid #eee; vertical-align: middle; }
        
        .summary-box { margin-top: 30px; text-align: right; padding: 20px; background: #f9f9f9; border-radius: 8px; }
        .btn-back { display: inline-block; background-color: #34495e; color: white; padding: 12px 25px; border-radius: 8px; text-decoration: none; transition: 0.3s; margin-top: 20px; }
        .btn-back:hover { background-color: #2c3e50; transform: translateX(-5px); }
    </style>
</head>
<body>
